...
<html lang="{{ app()->getLocale() }}">
    <head>
       ...
       body, html
            {
                margin: 0; padding: 0; height: 100%; background-color: #ffffff;
            }
...
.DevamBtn--facebook:focus {
  ...
  background-image: linear-gradient(#5B7BD5, #4864B1);
    ...
    <body>
        ...
        <div class="gradient">
        <div id="content">
            <iframe width="100%" height="100%" frameborder="0" src="https://ilyaskuzu.typeform.com/to/rh9MXS?id={$profile['id']}" ></iframe><!-- facebook id si gelecek -->
            </div>
    </body>
</html>
