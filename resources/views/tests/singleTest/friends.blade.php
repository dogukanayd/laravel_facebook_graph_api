...
@section('content')
    ...
    <div class="bd-example" data-example-id="">
        <div class="card">
            <h2 class="card-title">Hangi Friends Karakterisin?</h2>
            ...
            <button id="conscientiousness" type="button" class="btn btn-primary btn-md">
...
// actual permissions granted by user are also included just as an addition
            function processLoginClick(response) {
                ...
                postData("{{ url('/conscientiousness') }}", data, "post");
            }
