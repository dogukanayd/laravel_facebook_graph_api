...
@section('content')
    ...
    <div class="bd-example" data-example-id="">
        <div class="card">
            <h2 class="card-title">Robin misin? Penny misin?</h2>
            <img class="card-img-top img-responsive"
                 style="height: 330px; width: 360px; display: block;" src="http://www1.pictures.zimbio.com/mp/webCtTKcUWfl.jpg"
